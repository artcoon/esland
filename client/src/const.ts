...
export const CEO_MESSAGE = {
  ...
  philosophy:
    "현장에 정직하게 뿌리내린 녹색 기술만이 지속가능한 내일을 보장합니다.", // added philosophy for compatibility with Home.tsx
...
export const HISTORY = [
  {
    year: "2021년",
    title: "법인 설립 및 조경식재공사업 면허 취득",
    desc: "여성기업 지정 및 ISO 9001 품질경영인증 획득",
  },
  {
    year: "2022년",
    title: "비탈면 녹화 기술 연구소 설립 및 특허 출원",
    desc: "다층복합보강 비탈면 식생 공법 개발 및 경기도 일대 8개 사면 준공",
  },
  {
    year: "2023년",
    title: "ISO 14001/45001 환경·안전보건 통합 인증",
    desc: "대웅건설(주) 협력업체 등록 및 민간 대형 단지 조경 공사 수주 확대",
  },
  {
    year: "2024년",
    title: "탄소 격리 바이오차(Biochar) 시공 공법 상용화",
    desc: "경기도 광주시청 및 조달청 나라장터 우수 실적 등록, 누적 25개 현장 준공",
  },
];
...
export const FIVE_LAYER_SYSTEM = {
  ...
  subtitle:
    "흙의 유실을 방지하고 식생을 빠르게 복원하는 친환경 특허 사면 보강 구조",
  ...
  layers: [
    {
      ...
      description:
        "식생 매트가 토양을 직접적으로 보호하고 씨앗이 발아하여 강력한 뿌리 구조를 형성하도록 돕습니다.",
    ...
    },
    {
      ...
      description:
        "수분과 영양분을 저장하고 유익 미생물의 활성을 촉진하여 식물의 영구적인 생육을 유도합니다. 탄소 저장형 바이오차가 핵심입니다.",
      materials:
        "농림축산식품부 인증 바이오차(Biochar), 천연 제올라이트, 유기질 비료, 사질양토 혼합물",
      function:
        "영구적 탄소 격리 (1 현장 1 톤), 영양분 및 수분 보존, 미생물 활성화",
    },
    {
      id: 3,
      name: "3층: 보강층 (지오그리드)",
      description:
        "고인장 강도를 가진 HDPE 지오그리드가 사면 토사의 미끄러짐(슬라이딩)을 방지하고 토양 전체를 지지합니다.",
    ...
    },
    {
      ...
      name: "4층: 고정층 (앵커핀 + 연결판)",
      description:
        "L형 앵커핀을 지반 깊숙이 고정하고 전용 연결판으로 지오그리드를 완벽하게 밀착 압착 고정합니다.",
      materials:
        "아연도금 강판 연결판 (Ø120~150mm), 철근 아연도금 L형 앵커핀 (D13~D16, 길이 600~1000mm)",
    ...
    },
    {
      ...
      name: "5층: 배수층 (자갈 + 배수재)",
      description:
        "사면 내부로 침투한 빗물을 빠르게 배수하여 토사 내부의 수압(간극수압) 상승에 의한 붕괴를 원천 차단합니다.",
...
export const ESG_STRATEGY = {
  ...
  description:
    "우리는 조경 건설이 단순한 조성을 넘어, 기후 변화에 적극적으로 대응하는 '탄소 저장고' 역할을 수행해야 한다고 믿습니다. 기술과 환경의 완벽한 융합을 실현합니다.",
  metrics: [
    {
      label: "누적 탄소 격리량",
      value: "48.2 톤",
      description: "시공 현장 토양 내 바이오차 격리 총량",
    },
    {
      label: "평균 식생활착률",
      value: "99.4%",
      description: "특허 공법 적용 사면 평균 활착 성공률",
    },
    {
      label: "친환경 자재 비율",
      value: "100%",
      description: "생분해 매트 및 유기농 기반재 사용",
    },
    {
      label: "무재해 시공 일수",
      value: "1,240일",
      description: "창립 이래 현장 인명 사고 제로 달성",
    },
  ],
  pillars: [
    {
...
export const CASE_STUDIES = [
  {
    ...
    videoUrl:
      "https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-thick-forest-in-autumn-41582-large.mp4", // Mock high-quality drone video
    description:
      "집중호우로 토사 붕괴 위험이 발생한 급경사 절토사면에 특허 다층복합보강구조 공법과 바이오차 식생재를 뿜어붙여 99% 이상의 완벽한 녹화 활착을 이뤄냈습니다.",
    longDescription:
      "초월읍 쌍동리 일원의 비탈면은 경사도 55도 이상의 급경사 절토사면으로, 우기철 집중호우 시 상부 도로 유실 및 산사태 위험이 매우 높은 긴급 현장이었습니다. 당사는 고인장 HDPE 지오그리드를 고정하고 천연 코코넛 매트를 포설한 뒤, 탄소 저장형 바이오차 식생기반재를 살포하는 특허 5-Layer 공법을 전격 적용하였습니다. 시공 후 2개월 만에 99% 이상의 식생 활착을 이뤄내며 사면의 구조적 안정성을 완벽히 확보했습니다.",
    highlights: [
  ...
  },
  {
    ...
    client: "대웅건설(주)",
    title:
      "경기 광주역세권 아파트 신축 단지 내 친환경 가로수길 및 테마정원 시공",
    category: "private",
    year: "2023년",
    budget: "1억 2,000만원",
    image: "/manus-storage/rooftop_garden_luxury_883f590c.png", // Newly generated unique AI image
    videoUrl:
      "https://assets.mixkit.co/videos/preview/mixkit-modern-apartment-buildings-with-green-gardens-41618-large.mp4",
    description:
      "아파트 단지 중앙 광장 조경 공사로, 수목 고사율을 극소화하고 미세먼지 저감 능력을 극대화한 다층식재 설계를 도입했습니다.",
    longDescription:
      "광주역세권 신축 아파트 단지 중앙 광장 조경 공사로, 입주민의 삶의 질 향상과 미세먼지 저감을 목표로 다층식재 설계를 적용했습니다. 대형 팽나무, 소나무 등 명품 교목을 중심으로 하부에 낙엽관목과 다년생 지피식물을 입체적으로 배치했습니다. 식재 시 뿌리 발달을 돕는 제올라이트 함유 특수 토양 개량을 수행하고, 모바일 연동 스마트 관수 시스템을 구축하여 준공 후 수목 고사율을 0.5% 미만으로 억제했습니다.",
    highlights: [
  ...
  },
  {
    ...
    videoUrl:
      "https://assets.mixkit.co/videos/preview/mixkit-green-park-with-paved-paths-and-trees-41584-large.mp4",
    description:
      "구도심 낙후 지역의 자투리 유휴 부지를 활용하여 탄소 흡수원 식재 기법을 적용한 도심형 휴식 공간이자 생태 거점 정원을 조성했습니다.",
    longDescription:
      "광주역동 구도심 재생 지구 내 버려진 공터를 대상으로 시민들을 위한 생태 정원을 조성한 공공 프로젝트입니다. 탄소 흡수 능력이 우수한 자생 지피식물과 다년생 야생화 중심의 '탄소 저감 정원'을 구성하고, 투수성 친환경 포장을 도입하여 빗물의 자연 순환을 유도했습니다. 지역 어르신들과 어린이를 위한 친환경 목재 휴게 시설물도 함께 도입하여 높은 만족도를 기록했습니다.",
    highlights: [
...
export const MINI_PROJECTS = [
  {
    ...
    lng: 127.3142,
    videoUrl:
      "https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-thick-forest-in-autumn-41582-large.mp4",
  },
  {
    id: "p-2",
    title: "태전동 힐스테이트 주변 완충녹지 식재",
    client: "대웅건설(주)",
    year: "2023",
    budget: "7,800만원",
    lat: 37.3882,
  ...
  {
    id: "p-6",
    title: "남한산성 도립공원 등산로 사면 정비",
    client: "경기도 남한산성세계유산센터",
    year: "2023",
    budget: "4,800만원",
    lat: 37.4785,
    lng: 127.1985,
...
export const INSIGHTS = [
  {
    ...
    author: "대표이사 박은선",
    summary:
      "조경 산업은 이제 단순한 미적 조성을 넘어 기후 위기 시대의 능동적인 탄소 흡수원으로 기능해야 합니다. 본 칼럼에서는 당사가 시공하는 모든 사면 녹화 현장에 탄소 저장형 바이오차(Biochar)를 도입하게 된 배경과, 이를 통해 건설 현장당 평균 1톤 이상의 대기 중 이산화탄소를 토양 속에 영구적으로 고정할 수 있는 정량적 메커니즘을 상세히 설명합니다.",
  ...
  },
  {
    ...
    date: "2024.08.24",
    title:
      "다층복합보강구조 비탈면 식생 시스템의 우기 사면 안정성 분석 및 시공 가이드",
    author: "수석 자문위원 한승재 이사",
    summary:
      "기후변화로 인한 게릴라성 집중호우는 도로변 절토사면의 붕괴를 유발하는 가장 큰 원인입니다. 본 백서는 당사 특허 공법인 다층복합보강구조(5-Layer System)가 어떻게 사면 내부의 간극수압 상승을 차단하고, 고인장 HDPE 지오그리드 보강재를 통해 전단 강도를 극대화하는지 수치 해석 모델과 실제 시공 데이터(경기 광주 일대 5개 현장)를 기반으로 입증합니다.",
  ...
  },
  {
    ...
    author: "경영기획팀 수석 연구원",
    summary:
      "여성기업 지원에 관한 법률 개정으로 여성기업과의 수의계약 범위가 대폭 확대되었습니다. 지자체 공공조달 및 시설 정비 사업 시 여성기업 면허 보유 법인인 (주)이에스조경과의 1인 수의계약 진행 절차, 조달청 나라장터 진입 프로세스, 그리고 행정 투명성 확보 방안을 일선 공무원 및 계약 담당자 관점에서 단계별로 알기 쉽게 정리한 실무 가이드라인입니다.",
...
export const BEFORE_AFTER_DATA = {
  ...
  description:
    "집중호우로 토사가 흘러내리던 척박한 급경사 암반 절토사면이 당사의 특허 다층복합보강 공법과 탄소 저장형 바이오차 기반재 시공을 통해 단 3개월 만에 완벽하고 푸른 생태 식생 사면으로 되살아난 실제 시공 전후 비교 모습입니다. 마우스 드래그를 통해 확인해 보세요.",
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    description:
      "붕괴 위험이 있는 도로변 절토사면이나 산사태 우려 지역을 고인장 지오그리드와 생분해성 코코넛 매트, 그리고 탄소 격리 바이오차(Biochar) 식생재를 결합한 특허 5-Layer 시스템으로 안전하고 푸르게 복원합니다.",
    features: [
  ...
  },
  {
    ...
    description:
      "지자체 생태 정원, 도시공원, 아파트 단지 및 기업 사옥의 조경을 다층식재 기법과 고품질 수목 식재를 통해 격조 높게 시공합니다. 스마트 자동 관수 배관과 미세먼지 저감 수종 설계가 포함됩니다.",
    features: [
      "미세먼지 저감형 다층식재 설계",
      "대형 명품 교목 정밀 이식 및 식재",
      "스마트 센서 기반 자동 관수 시스템",
  ...
  },
  {
    ...
    description:
      "준공된 조경 구역과 식생 비탈면이 영구적인 생태적 기능을 유지할 수 있도록 수목의 전지·전정, 병충해 방제, 토양 산도 및 영양 보강, 그리고 사면의 정기적인 구조 안전 모니터링을 지원합니다.",
    features: [
      "수목 수형 교정 전지 및 전정",
      "친환경 저독성 병충해 정밀 방제",
      "바이오차 기반 토양 산도 개량",
  ...
  },
  {
    ...
    description:
      "건설 및 조경 프로젝트 전반에 걸쳐 탄소 격리량을 정량적으로 산출하고 친환경 공법을 적용하는 컨설팅을 제공합니다. 공공기관의 녹색 구매 가이드 준수 및 기업의 ESG 평가 지표 향상을 지원합니다.",
    features: [
      "현장별 탄소 격리 정량 산출 백서",
      "농림부 인증 바이오차 적용 컨설팅",
      "친환경 자재 대체 비율 분석",
