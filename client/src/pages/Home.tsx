...
export default function Home() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("무료 현장 진단 및 상담 신청이 정상 접수되었습니다! 담당 엔지니어가 24시간 이내에 연락드리겠습니다.");
    setStep(1);
    setFormData({
      companyName: "",
      contactPerson: "",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground overflow-x-hidden">
      ...
      <main className="flex-grow">
        ...
        <section id="home" className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-gradient-to-b from-[#F5F6F0]/60 via-background to-background">
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-12">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 text-left">
              ...
              <p className="text-[#6B6B5F] text-sm sm:text-base max-w-xl leading-relaxed font-medium">
                ...
                도심 속에 탄소를 흡수하는 고품격 조경 솔루션을 제안합니다. (주)이에스조경은 사람과 자연이 함께 숨 쉬는 내일을 짓습니다.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-border max-w-lg">
                <div className="flex flex-col">
                  <span className="font-serif text-2xl sm:text-3xl font-bold text-primary">2020년</span>
                  <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-1">회사 설립 연도</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-serif text-2xl sm:text-3xl font-bold text-secondary-foreground">25건</span>
                  <span className="text-[10px] text-primary font-bold uppercase tracking-wider mt-1">누적 준공 실적</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-serif text-2xl sm:text-3xl font-bold text-primary">9.8억원</span>
                  <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-1">2025년 시공능력평가액</span>
                </div>
              </div>
            </div>
        ...
        <section id="about" className="py-24 border-t border-border relative bg-card/10">
          ...
          <div className="container">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              ...
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                사람과 자연이 함께 숨 쉬는 <span className="text-primary">다음 세대의 조경</span>
              </h2>
              <p className="text-[#6B6B5F] text-sm leading-relaxed font-medium">
                (주)이에스조경은 조경식재 및 조경시설물 설치공사를 핵심 사업으로 삼고, 독자적인 친환경 기술력과 투명한 신뢰 경영을 통해 미래 환경 가치를 창출하는 전문건설 법인입니다.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-24">
              ...
              <div className="lg:col-span-7 text-left flex flex-col gap-6">
                ...
                <h3 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                  &ldquo;뿌리가 깊은 나무는<br />
                  <span className="text-primary">흔들리지 않습니다.</span>&rdquo;
                </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-24 pt-16 border-t border-border/60">
              <div className="lg:col-span-4 text-left flex flex-col gap-4">
                <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Corporate Overview</span>
                <h3 className="font-serif text-2xl font-bold text-[#173B57]">기업 개요 및 공신력</h3>
                <p className="text-sm text-muted-foreground leading-relaxed font-medium">
                  (주)이에스조경은 자본금 1억 5,500만원 규모의 탄탄한 재무 구조와 전문공제조합 가입을 완료한 정식 등록 법인입니다. 여성기업 수의계약 한도 확대 등 공공 입찰 참여에 완벽한 자격을 갖추고 있습니다.
                </p>
              </div>
              <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
                <div className="p-5 rounded-xl bg-background border border-border/60 flex flex-col gap-2">
                  <span className="text-[10px] text-primary font-bold uppercase tracking-wider">법인 등록 정보</span>
                  <ul className="text-xs text-[#6B6B5F] font-medium flex flex-col gap-2">
                    <li><strong>법인명:</strong> 주식회사 이에스조경</li>
                    <li><strong>설립일:</strong> 2020년 06월 12일</li>
                    <li><strong>사업자등록번호:</strong> 592-87-01625</li>
                    <li><strong>법인등록번호:</strong> 205411-0033219</li>
                  </ul>
                </div>
                <div className="p-5 rounded-xl bg-background border border-border/60 flex flex-col gap-2">
                  <span className="text-[10px] text-primary font-bold uppercase tracking-wider">건설업 면허 및 주력분야</span>
                  <ul className="text-xs text-[#6B6B5F] font-medium flex flex-col gap-2">
                    <li><strong>보유 면허:</strong> 조경식재·시설물공사업 (2020-16-05호)</li>
                    <li><strong>면허 유효기간:</strong> 2026.02.11 ~ 2029.02.10</li>
                    <li><strong>시공 능력 평가액:</strong> 983,046,000원 (2025년 기준)</li>
                    <li><strong>신용 등급:</strong> EW등급 (CREVIEW 신용평가인증)</li>
                  </ul>
                </div>
                <div className="p-5 rounded-xl bg-background border border-border/60 flex flex-col gap-2 sm:col-span-2">
                  <span className="text-[10px] text-primary font-bold uppercase tracking-wider">대외 공신력 및 인증 혜택</span>
            ...
            <div className="pt-16 border-t border-border/60">
              <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
                ...
                <h3 className="font-serif text-2xl font-bold text-[#173B57]">신뢰와 혁신으로 다져온 발자취</h3>
              </div>
        ...
        <section className="py-24 bg-card/30 border-y border-border/80 relative">
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              ...
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                자연과 인간의 상생을 짓는 <span className="text-primary">지속가능한 조경</span>
              </h2>
              <p className="text-[#6B6B5F] text-sm leading-relaxed font-medium">
        ...
        <section id="services" className="py-24">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              ...
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                특허 기술이 집약된 <span className="text-primary">사업 분야</span>
              </h2>
        ...
        <section className="py-24 bg-card/30 border-y border-border/80 relative">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">PATENTED TECHNOLOGY</span>
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                다층복합보강구조 <span className="text-primary">5-Layer 시스템</span>
              </h2>
              <p className="text-[#6B6B5F] text-sm leading-relaxed font-medium">
                비탈면의 안전을 보장하는 구조 보강 엔지니어링과 영구적인 식생활착 유도 공법을 결합하여 집중호우에도 토사 붕괴와 유실을 완벽하게 차단합니다.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-left">
              ...
              <div className="lg:col-span-7 flex flex-col gap-4">
                <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 flex gap-4 items-start">
                  <div className="h-8 w-8 rounded-lg bg-primary text-primary-foreground flex items-center justify-center font-serif font-bold text-sm shrink-0">1</div>
                  <div>
                    <h4 className="font-serif text-sm font-bold text-foreground">식생층 (Vegetation Layer)</h4>
                    <p className="text-xs text-muted-foreground mt-1">생분해 PLA 및 코코넛 매트로 표면 토사 유실 방지 및 식생 종자의 안전한 발아와 조기 안착 유도</p>
                  </div>
                </div>
                <div className="p-4 rounded-xl border border-border bg-background flex gap-4 items-start">
                  <div className="h-8 w-8 rounded-lg bg-secondary text-secondary-foreground flex items-center justify-center font-serif font-bold text-sm shrink-0">2</div>
                  <div>
                    <h4 className="font-serif text-sm font-bold text-foreground">식생기반층 (Growth Media Layer)</h4>
                    <p className="text-xs text-muted-foreground mt-1">탄소 저감형 바이오차(Biochar) 및 제올라이트 혼합 식생기반재(50~100mm)를 뿜어붙여 척박지 수분·영양 저장</p>
                  </div>
                </div>
                <div className="p-4 rounded-xl border border-border bg-background flex gap-4 items-start">
                  <div className="h-8 w-8 rounded-lg bg-muted-foreground/20 text-foreground flex items-center justify-center font-serif font-bold text-sm shrink-0">3</div>
                  <div>
                    <h4 className="font-serif text-sm font-bold text-foreground">보강층 (Reinforcement Layer)</h4>
                    <p className="text-xs text-muted-foreground mt-1">고인장 HDPE 지오그리드(인장강도 ≥20kN/m)를 밀착 포설하여 토양 전단강도 강화 및 비탈 슬라이딩 방지</p>
                  </div>
                </div>
                <div className="p-4 rounded-xl border border-border bg-background flex gap-4 items-start">
                  <div className="h-8 w-8 rounded-lg bg-muted-foreground/20 text-foreground flex items-center justify-center font-serif font-bold text-sm shrink-0">4</div>
                  <div>
                    <h4 className="font-serif text-sm font-bold text-foreground">고정층 (Anchoring Layer)</h4>
                    <p className="text-xs text-muted-foreground mt-1">이중 와셔 및 L형 앵커핀(500~800mm 매입) 고정 공법으로 사면 내부 지탱력 강화</p>
                  </div>
                </div>
                <div className="p-4 rounded-xl border border-border bg-background flex gap-4 items-start">
                  <div className="h-8 w-8 rounded-lg bg-muted-foreground/20 text-foreground flex items-center justify-center font-serif font-bold text-sm shrink-0">5</div>
                  <div>
                    <h4 className="font-serif text-sm font-bold text-foreground">배수층 (Drainage Layer)</h4>
                    <p className="text-xs text-muted-foreground mt-1">배수 자갈층(100~150mm) 및 종방향 유공관 시공으로 우기 간극수압 상승을 차단하고 신속한 지하수 배출 유도</p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="relative w-full max-w-md rounded-2xl overflow-hidden border border-border shadow-xl aspect-square">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-left">
                    <span className="text-[10px] font-bold text-primary uppercase tracking-widest">ECOLOGICAL RESTORATION</span>
                    <h4 className="font-serif text-lg font-bold text-foreground mt-1">기후변화 대응형 녹화 엔지니어링</h4>
                    <p className="text-xs text-muted-foreground mt-1 font-medium">단순 지탱을 넘어, ㎡당 2kg 이상의 탄소를 토양에 가두는 과학적 생태 복원입니다.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="portfolio" className="py-24">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Client Results</span>
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-12">
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold border transition-all cursor-pointer ${
                  portfolioFilter === "all" ? "bg-primary text-primary-foreground border-primary" : "bg-card/60 text-muted-foreground border-border"
                }`}
              >
                전체 보기
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold border transition-all cursor-pointer ${
                  portfolioFilter === "slope" ? "bg-primary text-primary-foreground border-primary" : "bg-card/60 text-muted-foreground border-border"
                }`}
              >
                사면복원 · 녹화
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold border transition-all cursor-pointer ${
                  portfolioFilter === "public" ? "bg-primary text-primary-foreground border-primary" : "bg-card/60 text-muted-foreground border-border"
                }`}
              >
                공공 조경 식재
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold border transition-all cursor-pointer ${
                  portfolioFilter === "private" ? "bg-primary text-primary-foreground border-primary" : "bg-card/60 text-muted-foreground border-border"
                }`}
              >
                민간 · 대기업 조경
              </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {filteredPortfolio.map((study) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-bold text-primary uppercase tracking-widest">{study.client}</span>
                  <h3 className="font-serif text-base font-bold text-[#173B57] line-clamp-1">{study.title}</h3>
                  <p className="text-xs text-muted-foreground line-clamp-2 font-medium">{study.description}</p>
                  ...
                  <div className="mt-2 pt-3 border-t border-border/60 flex items-center justify-between text-xs font-bold">
                    {study.kpis.slice(0, 2).map((kpi, idx) => (
                      <div key={idx} className="flex flex-col gap-0.5">
                        <span className="text-[9px] text-muted-foreground font-semibold">{kpi.label}</span>
        ...
        {selectedCase && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-foreground/40 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="relative w-full max-w-3xl rounded-2xl border border-border bg-background p-6 shadow-2xl max-h-[90vh] overflow-y-auto text-left flex flex-col gap-6">
              ...
              <span className="text-[10px] font-bold text-primary uppercase tracking-widest">{selectedCase.client}</span>
              <h3 className="font-serif text-2xl font-bold text-[#173B57]">{selectedCase.title}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {selectedCase.kpis.map((kpi, idx) => (
                  <div key={idx} className="p-3 rounded-xl bg-[#F5F6F0] border border-border/40 text-center flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-2">
                <h4 className="font-serif text-sm font-bold text-foreground">상세 시공 개요</h4>
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed font-medium">{selectedCase.longDescription}</p>
              </div>

              <div className="flex flex-col gap-2">
                <h4 className="font-serif text-sm font-bold text-foreground">핵심 엔지니어링 성과</h4>
        ...
        <section id="insights" className="py-24 bg-card/30 border-y border-border/80 relative">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-4">
              <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Insights Lab</span>
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                전문 전략 및 <span className="text-primary">기술 자문 자료</span>
              </h2>
              <p className="text-muted-foreground text-sm leading-relaxed font-medium">
                (주)이에스조경의 수석 전략 자문위원 한승재 이사와 대표이사 박은선이 기고한 기후대응 기술 백서 및 조경 산업의 ESG 도입 전략 보고서 핵심 요약을 공개합니다.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {INSIGHTS.map((insight) => (
                <div key={insight.id} className="luxury-card flex flex-col gap-4 text-left border-primary/10 hover:border-primary/30 bg-background/80 shadow-sm">
                  ...
                  <h3 className="font-serif text-base font-bold text-[#173B57] line-clamp-2 leading-snug">{insight.title}</h3>
                  <p className="text-xs text-muted-foreground line-clamp-4 font-medium leading-relaxed">{insight.summary}</p>
                  
                  <div className="mt-auto pt-4 border-t border-border/60 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1.5">
                      <User className="h-3.5 w-3.5 text-primary" />
                      <span className="font-semibold text-muted-foreground">{insight.author}</span>
                    </div>
                    <button 
                      onClick={() => toast.info(`"${insight.title}" 전문 PDF 다운로드가 준비 중입니다.`)}
        ...
        <section id="contact" className="py-24">
          <div className="container max-w-4xl">
            <div className="text-center mx-auto mb-16 flex flex-col gap-4">
              <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Free Diagnosis</span>
              <h2 className="font-serif text-3xl font-bold tracking-tight text-[#173B57]">
                무료 현장 진단 및 <span className="text-primary">기술 자문 신청</span>
              </h2>
              <p className="text-muted-foreground text-sm leading-relaxed font-medium">
                여성기업 수의계약 가이드부터 다층복합보강 특허 공법 설계까지, 당사의 전문 기술이사가 직접 현장을 분석하고 무료 최적화 포트폴리오를 제공해 드립니다.
              </p>
            </div>
              ...
              <form onSubmit={handleFormSubmit} className="flex flex-col gap-6">
                {step === 1 && (
                  <div className="flex flex-col gap-5 animate-in fade-in duration-300">
                    <h3 className="font-serif text-lg font-bold text-[#173B57]">기본 기업 및 연락처 정보</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">회사명 / 기관명</label>
                        <Input 
                          name="companyName" 
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">담당자명</label>
                        <Input 
                          name="contactPerson" 
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">연락처 (휴대폰)</label>
                        <Input 
                          name="phone" 
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">이메일 주소</label>
                        <Input 
                          type="email" 
                          name="email" 
                ...
                {step === 2 && (
                  <div className="flex flex-col gap-5 animate-in fade-in duration-300">
                    <h3 className="font-serif text-lg font-bold text-[#173B57]">현장 및 시공 조건 분석</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">요청 공사 구분</label>
                        <div className="grid grid-cols-2 gap-2">
                          {["사면 복원 · 녹화", "공공 조경 식재", "유지관리 용역", "실내 플랜테리어"].map((type) => (
                            <button
                              key={type}
                              type="button"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-foreground">사면 경사도 (사면공사 시 필수)</label>
                        <div className="grid grid-cols-2 gap-2">
                          {["30도 미만 (완경사)", "30~45도 (중경사)", "45~60도 (급경사)", "60도 이상 (절토면)"].map((angle) => (
                            <button
                              key={angle}
                              type="button"
                              onClick={() => handleSelectChange("slopeAngle", angle)}
                              className={`py-2 px-3 rounded-lg text-xs font-semibold border transition-all text-center cursor-pointer ${
                      ...
                      <div className="flex flex-col gap-1.5 sm:col-span-2">
                        <label className="text-xs font-bold text-foreground">예상 공사 예산 규모</label>
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                          {["2천만원 미만", "2천만 ~ 5천만원", "5천만 ~ 1억원", "1억원 이상"].map((bud) => (
                            <button
                              key={bud}
                              type="button"
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          if (!formData.projectType || !formData.budget) {
                            toast.error("프로젝트 유형 및 예산 범위를 선택해 주세요.");
                            return;
                          }
                          setStep(3);
                        }} 
                ...
                {step === 3 && (
                  <div className="flex flex-col gap-5 animate-in fade-in duration-300">
                    <h3 className="font-serif text-lg font-bold text-[#173B57]">진단 요청 내용 상세 입력</h3>
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-bold text-foreground">현장 상세 상황 및 요구사항</label>
                      <Textarea 
                        name="details" 
                    ...
                    <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 text-xs text-primary leading-relaxed font-semibold">
                      ✓ 본 요청이 완료되면 (주)이에스조경의 전문 기술이사가 직접 인공위성 지형도 분석 및 로드뷰 정밀 분석을 거친 뒤 무료 1차 소견서와 맞춤형 견적 제안서를 송부해 드립니다.
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <Button 
                        ...
                        className="btn-gold h-11 flex-1 cursor-pointer"
                      >
                        무료 진단 요청 제출하기 <CheckCircle2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </div>
                )}
